...
To let anyone play from the internet, you can deploy to platforms like:
...
> The `database.sqlite` file stores all player data. Back it up if you care about saves.
